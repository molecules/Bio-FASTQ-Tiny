...
=head2 extract_singletons_from_paired_fastq (utility in bin directory)
...
=head2 extract_barcoded_fastq_with_min_length (utility in bin directory)

TODO

=head2 FASTQ_Hash.pl (utility in bin directory)
