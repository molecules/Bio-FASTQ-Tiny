...
=head1 extract_singletons_from_paired_fastq (utility in bin directory)
...
=head1 extract_barcoded_fastq_with_min_length (utility in bin directory)

TODO

=head1 FASTQ_Hash.pl (utility in bin directory)
